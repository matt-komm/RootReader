...
filePathTrain = "/vols/cms/mkomm/LLP/samples_nanox_ctau_1_train.txt"
filePathTest = "/vols/cms/mkomm/LLP/samples_nanox_ctau_1_test.txt"

fileListTrain = []
fileListTest = []


outputFolder = "nanox_ctau_1_test"
...
def setupModel(add_summary=False,options={}):
    ...
    conv_prediction,lstm1_prediction,full_prediction = llp_model.model(
...
while (epoch<61):
    ...
    train_batch = input_pipeline(fileListTrain,10000)
    test_batch = input_pipeline(fileListTest,5000)
    '''
